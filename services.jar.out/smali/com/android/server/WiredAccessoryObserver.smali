...
.method private static makeObservedUEventList()Ljava/util/List;
    ...
    .line 127
    .local v1, retVal:Ljava/util/List;,"Ljava/util/List<Lcom/android/server/WiredAccessoryObserver$UEventInfo;>;"
    new-instance v2, Lcom/android/server/WiredAccessoryObserver$UEventInfo;

    const-string v3, "headset_sensor"

    invoke-direct {v2, v3, v6, v7}, Lcom/android/server/WiredAccessoryObserver$UEventInfo;-><init>(Ljava/lang/String;II)V

    .line 128
    .local v2, uei:Lcom/android/server/WiredAccessoryObserver$UEventInfo;
    invoke-virtual {v2}, Lcom/android/server/WiredAccessoryObserver$UEventInfo;->checkSwitchExists()Z
    ...
    .end local v2           #uei:Lcom/android/server/WiredAccessoryObserver$UEventInfo;
    const-string v3, "usb_audio"

    invoke-direct {v2, v3, v8, v9}, Lcom/android/server/WiredAccessoryObserver$UEventInfo;-><init>(Ljava/lang/String;II)V

    .line 142
    .restart local v2       #uei:Lcom/android/server/WiredAccessoryObserver$UEventInfo;
    invoke-virtual {v2}, Lcom/android/server/WiredAccessoryObserver$UEventInfo;->checkSwitchExists()Z
    ...
    invoke-direct {v2, v3, v9, v8}, Lcom/android/server/WiredAccessoryObserver$UEventInfo;-><init>(Ljava/lang/String;II)V
    ...
    .end local v2           #uei:Lcom/android/server/WiredAccessoryObserver$UEventInfo;
    const-string v3, "hdmi_audio"

    const/16 v4, 0x10

    invoke-direct {v2, v3, v4, v5}, Lcom/android/server/WiredAccessoryObserver$UEventInfo;-><init>(Ljava/lang/String;II)V
    ...
    .line 132
    .local v0, headset_name:Ljava/lang/String;
    new-instance v2, Lcom/android/server/WiredAccessoryObserver$UEventInfo;
    ...
    const-string v4, "This kernel does not have wired headset support"
    ...
    .line 145
    .end local v0           #headset_name:Ljava/lang/String;
    :cond_2
    sget-object v3, Lcom/android/server/WiredAccessoryObserver;->TAG:Ljava/lang/String;

    const-string v4, "This kernel does not have usb audio support"
    ...
    const-string v4, "This kernel does not have samsung usb dock audio support"
    ...
    const-string v4, "This kernel does not have HDMI audio support"
